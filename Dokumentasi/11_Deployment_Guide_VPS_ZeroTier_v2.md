...
**Stack:** Laravel, Blade, Tailwind CSS, Alpine.js, Chart.js, MySQL, RSyslog, Firebird 2.5, Windows Agent, Telegram Bot, ZeroTier  
...
| 3306 | TCP | Localhost/internal only | MySQL monitoring DB |
...
| MySQL | Jangan expose publik. Bind local/internal saja. |
