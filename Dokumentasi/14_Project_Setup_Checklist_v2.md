...
**Stack Utama:** Laravel, Blade, Tailwind CSS, Alpine.js, Chart.js, MySQL, RSyslog, Firebird 2.5, Windows Agent, Telegram Bot, ZeroTier, GitHub  
...
- Versi detail PHP, MySQL, dan Firebird disesuaikan dengan compatibility Accurate/Firebird 2.5.
...
| 3306 | Localhost only | MySQL | Jangan public. |
