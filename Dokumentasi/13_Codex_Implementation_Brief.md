...
**Stack Utama:** Laravel, Blade, Tailwind CSS, Alpine.js, Chart.js, MySQL/MariaDB, RSyslog, Firebird 2.5, Windows Agent, ZeroTier, Telegram Bot  
...
| Database Monitoring | MySQL / MariaDB | Menyimpan device, telemetry, logs, alerts, audit events. |
