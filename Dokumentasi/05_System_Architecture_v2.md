...
10. Alur penyimpanan data ke MySQL/MariaDB.
...
2. **Monitoring Server Layer**  
   VPS Linux yang menjalankan RSyslog Server, Laravel Dashboard, MySQL/MariaDB, Firebird Server, Accurate Audit Reader, Telegram Alert Service, dan Remote Command API.
...
| VPS Linux | Monitoring + database server | Menjalankan RSyslog, Laravel, MySQL/MariaDB, Firebird, dan ZeroTier. |
...
4. Menyimpan telemetry device ke MySQL/MariaDB.
5. Menyimpan network check ke MySQL/MariaDB.
...
## 6.4 MySQL/MariaDB Monitoring Database
...
4. Menyimpan hasil query ke tabel `accurate_audit_events` di MySQL/MariaDB.
...
|                                                                                  |
| +-------------------+       +---------------------+       +--------------------+ |
| | Firebird Server   |<----->| Accurate Audit      |------>| MySQL/MariaDB      | |
...
3. MySQL/MariaDB tidak perlu dibuka publik.
...
| ARCH-003 | Laravel Parser membaca raw log dan menyimpan data terstruktur ke MySQL/MariaDB. |
