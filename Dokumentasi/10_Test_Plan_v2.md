...
**Stack:** VPS Linux, ZeroTier, RSyslog, Laravel, Blade, Tailwind CSS, Alpine.js, Chart.js, MySQL/MariaDB, Firebird 2.5, Windows Agent, Telegram Bot  
...
2. Satu VPS Linux sebagai pusat monitoring, RSyslog server, Laravel dashboard, MySQL/MariaDB, Firebird server, Accurate database, Accurate Audit Reader, dan Telegram Alert Service.
...
| TC-SERVER-005 | DB monitoring running | Cek MySQL/MariaDB | Status running dicatat | Pending |
