...
**Stack:** VPS Linux, ZeroTier, RSyslog, Laravel, MySQL/MariaDB, Firebird 2.5, Windows Agent, Blade, Tailwind CSS, Alpine.js, Chart.js, Telegram Bot  
...
| Komponen | Peran |
|---|---|
| VPS Linux | Pusat monitoring, RSyslog Server, Laravel Dashboard, MySQL/MariaDB, Firebird, Accurate Audit Reader, Telegram Alert Service, Remote Command API. |
...
↓
Laravel memproses data ke MySQL/MariaDB
↓
