...
- Alpine.js
- Chart.js
- MySQL or MariaDB for VPS deployment
...
Local `.env.example` defaults to SQLite. For MySQL or MariaDB:
...
1. Install Linux base packages, PHP extensions, Composer, Node.js build tooling if building assets on VPS, Nginx, MariaDB/MySQL, RSyslog, ZeroTier, and Firebird 2.5.
