...
1 VPS Linux with Laravel, MariaDB/MySQL, RSyslog, Firebird 2.5, ZeroTier
...
sudo apt update
sudo apt upgrade -y
sudo apt install -y git curl unzip ca-certificates gnupg ufw rsyslog nginx mariadb-server mariadb-client
```
